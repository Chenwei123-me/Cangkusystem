    ...
    <table width=60% align="center">
            ...
            <td >
                <form name="form1" action="" method="post">
                    <table border=1 width=100%>
                        <tr align="center">
                            <td width=4%><input type="checkbox" name="checkall" onclick="javascript:selectAll(this.checked);" /></td>
                            <td width=12%>序号</td>
                            <td width=12%>物品名称</td>
                            <td width=12%>品牌</td>
                            <td width=12%>规格型号</td>
        ...
        <tr>
            <td>
                ...
                <button type="button" onclick="javascript:view();" >导入</button>
                <button type="button" onclick="javascript:view();" >导出</button>
